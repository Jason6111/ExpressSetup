...
insweb(){
readp "设置naiveproxy伪装网址，注意：不要带https（不懂的话，直接回车跳过，默认为 www.xxxxx520.com ）：" web
if [[ -z ${web} ]]; then
naweb=sway.office.com/ZyHdQKVF0lCLyEuA
else
naweb=$web
fi
blue "已确认伪装网址：${naweb}\n"
...
Documentation=https://github.com/Jason6111/ExpressSetup/tree/main/naiveproxy

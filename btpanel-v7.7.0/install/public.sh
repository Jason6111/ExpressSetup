...
if [ -d "/www/server/phpmyadmin/pma" ];then
	...
	if [ "${EN_CHECK}" ];then
		curl https://raw.githubusercontent.com/Jason6111/ExpressSetup/main/btpanel-v7.7.0/install/update6_en.sh|bash
	else
		curl https://raw.githubusercontent.com/Jason6111/ExpressSetup/main/btpanel-v7.7.0/install/update6.sh|bash
	fi
